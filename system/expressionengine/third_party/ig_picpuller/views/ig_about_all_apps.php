...
<table border="1" cellspacing="2" cellpadding="5" width='100%'>
	...
	?>
	<tr ><td><?php if ($site_ids[$i] === $current_site_id) { echo"<strong>";} ?><?=$site_labels[$i];?><?php if ($site_ids[$i] === $current_site_id) { echo"</strong>";} ?><td><?=$client_ids[$i];?></td><td><?=$client_secrets[$i];?></td></tr>
	<?php } ?>
</table>
<br>
