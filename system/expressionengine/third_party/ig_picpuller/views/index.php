...
<?php if (!$preexisting_app) {?>
	...
	<p>You will be asked for a Redirect URI (a.k.a., oAuth URL) in the creation process. Below is URL you will need.</p>
...
<?php } else { ?>
	...
	<h4 class='step'><span class='larger_icon'>&#9745;</span> Step 1 - Set up your app on Instagram</h4>
	<p>Nice job. It appears you've completed this step. As a reminder, below is the Redirect URI the app should be using.</p>
	<p><input type="text" value="<?php echo $full_auth_url;?>" class="oauthcode" style='width: 74%;'></p>
