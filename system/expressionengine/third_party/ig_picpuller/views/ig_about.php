...
<table border="1" cellspacing="2" cellpadding="5" width='100%'>
	<tr><th>Instagram Client ID</th><th>Instagram Client Secret</th><th>Front-end Authorization URL</th></tr>
	<tr><td><?=$client_id;?></td><td><?=$client_secret;?>&nbsp;&nbsp;(<a href="<?=$edit_secret;?>" title='Edit Secret'>edit</a>)</td><td><?=$frontend_auth_url;?>&nbsp;&nbsp;(<a href="<?=$edit_frontend_url;?>" title='Edit Front-end URL'>edit</a>)</td></tr>
</table>
<br>
